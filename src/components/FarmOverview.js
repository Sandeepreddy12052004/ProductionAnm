...
export default function FarmOverview({ farmCode }) {
  ...
  if (loading) {
    return (
      <div className="p-4 md:p-8 w-full max-w-[1600px] mx-auto min-h-screen bg-transparent text-slate-800">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div className="w-1/3">
            <SkeletonLoader type="block" height="h-8" className="mb-2" />
            <SkeletonLoader type="block" height="h-4" />
          </div>
        </div>
        ...
        <div className="mt-8">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
             <div className="p-6 border-b border-gray-100">
               <SkeletonLoader type="block" height="h-6" className="w-1/4" />
             </div>
             <table className="w-full text-left border-collapse">
               <tbody>
                 <SkeletonLoader type="table" columns={4} rows={4} />
               </tbody>
             </table>
          </div>
        </div>
